...
{
  title: "Writing Comments In Your Code",
  content: `Hodor hodor HODOR! Hodor hodor - hodor, hodor. Hodor hodor... Hodor hodor hodor; hodor hodor. Hodor hodor hodor, hodor, hodor
  hodor. Hodor, hodor. Hodor. Hodor, hodor - hodor... Hodor hodor hodor; hodor HODOR hodor, hodor hodor?! Hodor hodor, hodor.
  Hodor hodor hodor hodor hodor! Hodor hodor - HODOR hodor, hodor hodor hodor hodor hodor; hodor hodor? 
 ...
 function createArticles(title, content) {
  ...
  /*<div class="articles">
      <div class="article">
        ...
        <p class="date">Nov 5th, 2018</p> */

  
  // Defined new elements
  const articles = document.createElement('div')
  const articlesParent = document.createElement('div')
  const titles = document.createElement('h2')
  const paragraph = document.createElement('p')      
 }

 const accordion = document.querySelector(".expandButton")
 
 accordion.appendChild(articleData())
